...
// 🟢 আপনার তৈরি করা সিম্পল ফ্রন্টএন্ড API কল ফাংশন
...
const ProfilePage = () => {
  ...
  // Session data load হলে state আপডেট করার জন্য
  useEffect(() => {
    if (session?.user) {
      setFormData({
        ...
        image: session.user.image || "", // খালি স্ট্রিং জেনারেট করা এরর দূর করতে null ব্যবহার করা হয়েছে
      });
    }
  }, [session]);
      ...
      <div className="mx-auto ml-5">
        ...
        <div className="my-8 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-300 md:text-base">
              Manage your personal details, donor identity, and account preferences from one dashboard.
            </p>
          </div>
