...
//             </h1>
//             <p className="text-white mt-3 text-lg">The Requests Details page provides in-depth information and updates regarding a specific user request.</p>
//         </div>
//     );
// };
...
//     if (!req) {
//         return (
//             <div className="min-h-screen bg-zinc-950/70 text-zinc-100 py-8 px-4 flex items-center justify-center">
//                 <div className="text-center">
//                     <h2 className="text-3xl font-bold text-red-500">Request Not Found</h2>
//                     <p className="text-zinc-400 mt-3">The requested blood donation post may have been removed.</p>
//                 </div>
//             </div>
//         );
//     }
...
//                                         {req.hospitalAddress && (
//                                             <p className="text-sm text-zinc-500 mt-1">{req.hospitalAddress}</p>
//                                         )}
//                                     </div>
//                                 </div>
...
//                         <button className="w-full bg-red-600 hover:bg-red-700 transition-all active:scale-[0.98] text-white font-semibold text-lg py-4 rounded-2xl shadow-lg shadow-red-600/30">
//                             Donate Now
//                         </button>
//                     </div>
//                 </div>
...
// import { getBReqestById } from '@/lib/api/allBloodRequest';
// import { updateRequestStatus } from '@/lib/api/allBloodRequest'; // ← নতুন API ফাংশন লাগবে
// import React, { useState } from 'react';
// import { FaHospital, FaMapMarkerAlt, FaCalendarAlt, FaClock, FaUser } from 'react-icons/fa';
// import { toast } from 'react-toastify';
// // import toast, { Toaster } from 'react-hot-toast';   // ← toast এর জন্য (npm install react-hot-toast)
...
//     if (!req) {
//         return <div className="min-h-screen bg-zinc-950/70 flex items-center justify-center text-red-500">Request Not Found</div>;
//     }

//     // Client Component এর জন্য wrapper
...
//             // Optional: কিছুক্ষণ পর পেজ রিফ্রেশ বা redirect
//             setTimeout(() => {
